...
public:
    ...
    /**
     * \brief   Selects and reveals the attribute with the given document ID (go-to-declaration
     *          target from the canvas, or a validation finding). Does nothing if no attribute
     *          has that ID.
