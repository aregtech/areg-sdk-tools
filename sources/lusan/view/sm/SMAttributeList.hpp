#ifndef LUSAN_VIEW_SM_SMATTRIBUTELIST_HPP
#define LUSAN_VIEW_SM_SMATTRIBUTELIST_HPP
/************************************************************************
 ...
 *  \file        lusan/view/sm/SMAttributeList.hpp
...
/**
 * \brief   The attribute list panel, code-built to mirror SIAttributeList: an
 *          "Attributes List:" group holding the add/insert/delete + move up/down toolbar
 *          above a 3-column flat list (Name/Data Type/Value).
 **/
class SMAttributeList : public QWidget
{
    Q_OBJECT

public:
    explicit SMAttributeList(QWidget* parent = nullptr);
...
#endif  // LUSAN_VIEW_SM_SMATTRIBUTELIST_HPP
