 ...
 *  \file        lusan/view/sm/SMConstantList.cpp
...
SMConstantList::SMConstantList(QWidget* parent /*= nullptr*/)
    : QWidget           (parent)
    , mTable            (nullptr)
    , mButtonAdd        (nullptr)
...
QTreeWidget* SMConstantList::ctrlTableList() const
{
    return mTable;
}

QToolButton* SMConstantList::ctrlButtonAdd() const
{
    return mButtonAdd;
}

QToolButton* SMConstantList::ctrlButtonInsert() const
{
    return mButtonInsert;
}

QToolButton* SMConstantList::ctrlButtonRemove() const
{
    return mButtonRemove;
}

QToolButton* SMConstantList::ctrlButtonMoveUp() const
{
    return mButtonMoveUp;
}

QToolButton* SMConstantList::ctrlButtonMoveDown() const
{
