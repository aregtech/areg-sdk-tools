...
public:
     ...
     **/
    inline LogOfflineExplorer& getOfflineLogs(void);
...
private:
    ...
    LogOfflineExplorer  mLogOfflineExplorer;//!< The offline log explorer widget.
...
inline LogOfflineExplorer& Navigation::getOfflineLogs(void)
{
    return mLogOfflineExplorer;
}
