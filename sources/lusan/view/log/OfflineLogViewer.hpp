...
private slots:
    ...
    /**
     * \brief   Slot, triggered when the reload button is clicked. It reads the archive
     *          again and drops every filter.
     **/
...
private:
    /**
     * \brief   Draws the time the loaded archive covers in the session bar.
     **/
    void updateSpan();
...
//////////////////////////////////////////////////////////////////////////
private:
    bool    mReleased;  //!< True once the widgets and the models of this window are released.
};
