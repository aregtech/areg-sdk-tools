...
namespace
{
    ...
    constexpr Row TABLE[]
    {
        ...
        , fixed(QLatin1StringView("mOwnPending")   , QLatin1StringView("the storage of the raised events"))
        , fixed(QLatin1StringView("mPending")      , QLatin1StringView("the raised events of the import tree"))
        , fixed(QLatin1StringView("mOwnDraining")  , QLatin1StringView("the storage of the draining flag"))
        , fixed(QLatin1StringView("mDraining")     , QLatin1StringView("the draining flag of the import tree"))
