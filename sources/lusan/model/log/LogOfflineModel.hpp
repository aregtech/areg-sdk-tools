...
inline QString LogOfflineModel::getModelName(void) const
{
...
inline QString LogOfflineModel::getLogFileName(void) const
{
    ...
    dbPath = dbPath.isEmpty() ? File::getFileNameWithExtension(dbPath) : dbPath;
    return QString::fromStdString(dbPath.getData());
}
