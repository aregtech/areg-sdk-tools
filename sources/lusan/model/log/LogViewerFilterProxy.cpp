...
LogViewerFilterProxy::LogViewerFilterProxy(QObject* parent)
...
void LogViewerFilterProxy::setSourceModel(QAbstractItemModel* sourceModel)
{
    mLogModel = qobject_cast<LogViewerModel*>(sourceModel);
